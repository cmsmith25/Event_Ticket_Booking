...
function Signup() {
    ...
    return (
        //Container for the signup form
         ...
         <h2 className="text-3xl font-bold mb-4 text-center text-blue-700">Join Here!</h2>
        ...
        <form onSubmit={handleSignup} className="space-y-5">
            <div>
                ...
                <input
                    ...
                    <button
                        type="Submit"
                        className="w-full bg-green-700 hover:bg-green-800 text-white font-semibold py-2 rounded transition duration-200">Sign Up</button>

                </form>

                {/*Link to the login page is user already exists*/}
                <p className="text-center text-sm text-gray-500 mt-6">Already have a login?<a href="/login" className="text-green-600 hover:underline">Log in</a>
