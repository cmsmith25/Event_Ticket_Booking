...
function Login() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            setError(err.message); //error for a failed login
        }
    }
    ...
    return (
        <div className="max-w-md mx-auto mt-20 p-8 bg-white rounded-xl shadow-lg">
            ...
            <h2 className="text-3xl  text-center font-bold mb-4  text-blue-700">Welcome Back!</h2>
            ...
            <form onSubmit={handleLogin}>
                ...
                <button
                    type="submit"
                    className="w-full bg-green-700 hover:bg-blue-800 text-white  py-2 rounded">Log In</button>
            </form>
